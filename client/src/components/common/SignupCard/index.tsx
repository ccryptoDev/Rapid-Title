  ...
  return (
    <>
      ...
      <div className='w-[100%] text-center 2xl:py-[40px] md:py-[40px] px-[50px] 2xl:px-[100px]'>
          <h1 className='2xl:text-6xl md:text-xl welcome 2xl:font-bold'>Welcome to Rapid<span className='text-[#FF3366]'>Title</span></h1>
