  ...
  return (
    <>
      ...
      <div className='w-[100%] text-center 2xl:py-[40px] md:py-[40px] px-[50px] 2xl:px-[100px]'>
          <h1 className='2xl:text-6xl xl:text-3xl welcome 2xl:font-bold'>Welcome to Rapid<span className='text-[#FF3366]'>Title</span></h1>
          <h1 className='xl:my-[10px] md:my-[10px] 2xl:my-[10px] text-lg'>Continue with</h1>
          ...
          <h1 className='xl:my-[10px] md:my-[10px] 2xl:my-[10px] text-lg'>Or Signup here</h1>
