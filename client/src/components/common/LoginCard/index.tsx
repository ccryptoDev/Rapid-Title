    ...
    <>
      <div className='w-[calc(100vw-500px)] h-[80vh] bg-white z-10 absolute login-card'>
        ...
        <div className='w-[100%] text-center 2xl:py-[60px] md:py-[40px] px-[50px]'>
          <h1 className='2xl:text-5xl md:text-xl welcome'>Welcome back Rapid<span className='text-[#FF3366]'>Title</span></h1>
          ...
          <div className='2xl:px-[70px] '>
            <form className="2xl:mt-8 md:space-y-3 2xl:space-y-8" action="#" method="POST">
              <input type="hidden" name="remember" value="true" />
              <div className="-space-y-px rounded-md shadow-sm">
                <div className='relative mb-[20px]'>
                  <input id="email-address" name="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} autoComplete={'off'} required className="relative block w-full rounded-t-md border-0 py-1.5 px-1.5 text-gray-500 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset sm:text-sm md:text-sm pl-5 sm:leading-6 2xl:h-[62px]" placeholder="Email address" />
